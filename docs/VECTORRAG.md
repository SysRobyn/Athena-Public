...
* [x] **Hybrid Search**: Combine vector + keyword + TAG_INDEX for precision → See [SEMANTIC_SEARCH.md](file:///Users/winstonkoh/Desktop/Project Athena/Athena-Public/docs/SEMANTIC_SEARCH.md)
